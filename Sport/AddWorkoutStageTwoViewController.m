...
@interface AddWorkoutStageTwoViewController () {
    ...
    __weak IBOutlet UILabel *pageDesc;
}

@end

@implementation AddWorkoutStageTwoViewController
@synthesize title, workoutType;
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (workoutType == wTime) {
        [pageDesc setText:@"Input the distance for each timed rep."];
    }
    else if (workoutType == wDistance) {
        [pageDesc setText:@"Input the time for each distance rep."];
    }
    else if (workoutType == wCustom) {
        [pageDesc setText:@"Input the time and distance for each rep."];
